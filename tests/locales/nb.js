module.exports = function(t, tb) {
  ...
  t.equal(tb.subSeconds(10), 'akkurat nå');
  t.equal(tb.subSeconds(21), 'akkurat nå');
  t.equal(tb.subSeconds(22), 'akkurat nå');
  t.equal(tb.addSeconds(1), 'om litt');
  t.equal(tb.addSeconds(10), 'om litt');
  t.equal(tb.addSeconds(21), 'om litt');
  t.equal(tb.addSeconds(22), 'om litt');
